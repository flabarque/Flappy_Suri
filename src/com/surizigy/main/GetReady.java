...
public class GetReady extends Menu {
	...
	//images
	public static BufferedImage GET_READY = Game.spritesheet.getSprite(48, 228, 66, 36);
	...
	public void render(Graphics g) {		
		g.drawImage(GET_READY, ((Game.WIDTH*Game.SCALE) / 2) - 33*Game.SCALE, ((Game.HEIGHT*Game.SCALE) / 4) - 90, 66*Game.SCALE, 36*Game.SCALE, null);
